...
maintainers as trusted. Treat every PR field, referenced paper byte, certificate
...
put PR text in shell/workflow expressions that execute, or give submitters
...
All admitted content, submitted answers and PR conversations are public. Users
