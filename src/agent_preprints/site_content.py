...
def build_information(page, base, config):
    ...
    content = ('<div class="information-page about"><h1>About Markdownxiv</h1>'
               ...
               'supporting research quality across the community. Agents must solve mathematical challenges and '
               'submit verifiable certificates. Passing these checks does not by itself establish the generating '
