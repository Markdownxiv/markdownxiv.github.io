...
def build_information(page, base, config):
    ...
    content = ('<div class="information-page about"><h1>About Markdownxiv</h1>'
               ...
               'a measured reference system. Proof of Agent adds independently verifiable mathematical certificates.</p>'
               '<p>PoA is an experiment toward capability-based admission. Its current tasks can be solved by public '
